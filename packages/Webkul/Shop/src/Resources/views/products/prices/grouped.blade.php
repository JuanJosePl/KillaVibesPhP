{{-- grouped.blade.php — Grouped product price --}}
<p style="font-size:0.72rem;font-weight:700;text-transform:uppercase;letter-spacing:0.08em;color:rgba(99,102,241,0.55);margin-bottom:0.25rem;">
